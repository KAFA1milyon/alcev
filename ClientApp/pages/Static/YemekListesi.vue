            ...
            <div class="container">
                <div class="article-content">
                    <div class="content-layer">
                        <h4>Özel Altınoluk Çağdaş Eğitim Vakfı İlkokulu ve Ortaokulu Yemek Listesi</h4>
                        <br><br>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Alaca Çorba</td>
                                    <td>Çıtır tavuk ve patates</td>
                                    <td>Garnitürlü pilav</td>
                                    <td>Meyve</td>
                                    <td>Salata Köşesi</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>Tarhana Çorbası</td>
                                    <td>Hasan paşa Köfte</td>
                                    <td>Boncuk makarna </td>
                                    <td>Meyve</td>
                                    <td>Salata Köşesi</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Brokoli Çorbası</td>
                                    <td>Balık</td>
                                    <td>Sebze eşliğinde spagetti</td>
                                    <td>Helva</td>
                                    <td>Salata Köşesi</td>
                                </tr>
                                <tr>
                        ...
                        <table class="table table-hover table-bordered">
                            <tr>
                                <td>Tavuk Ürünleri : </td>
                                <td>BANVİT</td>
                                <td></td>
                                <td>Ayran - Yoğurt - Tereyağ : </td>
                                <td>SAKIPAĞA</td>
                            </tr>
                            <tr>
                                <td>Et Ürünleri : </td>
                                <td>ÜNLÜ ET MAMULLERİ GÜRE</td>
                                <td></td>
                                <td>Zeytinyağı : </td>
                                <td>DROP</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>NUHUN ANKARA</td>
                                <td></td>
                                <td>Sucuk - Salam - Sosis : </td>
                                <td>PINAR</td>
                            </tr>
                            <tr>
                                <td>Baharatlar: </td>
                                <td>BAĞDAT BAHARAT</td>
                                <td></td>
                                <td></td>
                                <td></td>
                            </tr>
